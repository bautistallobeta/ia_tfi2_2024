...
with open("train_dataset/data.txt") as f:
    for line in f:
        xs.append("train_dataset/data/" + line.split()[0])
        #salida como angulo en radianes
        ys.append(float(line.split()[1]) * 3.14159265 / 180)

#traer el nro de imágenes
num_images = len(xs)
...
#dividir el dataset en 80% train y 20% test (se puede cambiar)
